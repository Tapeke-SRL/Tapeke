...
export default class PopupCodigoSeguridad extends Component {
    ...
    getVerificarCodigo(obj) {
        ...
        return <SForm
            ...
            inputs={{
                codigo_seguridad: { label: "Ingrese el código", placeholder: "0000", isRequired: true, col: "xs-12", type: "password",maxLength: 4 , autoFocus:true, keyboardType: "decimal-pad", },
            }}
    ...
    render() {
        return (
            <SView width={362} center row style={{ borderRadius: 32, overflow: "hidden", marginBottom:"30%" }} withoutFeedback backgroundColor={STheme.color.background}   >
