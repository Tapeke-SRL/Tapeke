    ...
    showMapa() {
        ...
        return <SView col={"xs-12"} height center >
            <SMapView2 initialRegion={
                ...
                <SMarker key={"MarkerCliente"} lat={this.props.data?.direccion?.latitude} lng={this.props.data?.direccion?.longitude} >
                    <SIcon name={"Marker"} width={50} height={50} fill={"#FA790E"} />
                </SMarker>
                <SMarker key={"MarkerDriver"} lat={this.state.region.latitude} lng={this.state.region.longitude} >
