                ...
                <Container>
                    <SForm
                        ...
                        inputs={{
                            ...
                            horario: { label: "Horario de recogida", type: "number", placeholder: "", defaultValue: horario, type: "select", options: this.getHoraOptions(), style:{paddingLeft:20, backgroundColor:STheme.color.card, fontSize:16} },
