    ...
    render_add() {
        return <SView col={"xs-12"} center>
            ...
            <SView col={"xs-12"} row center>
                ...
                <SView width={8} />
                <SText fontSize={14} flex>{"Ingresa el código con los guiones."}</SText>
            </SView>
            <SHr />
            <SView col={"xs-12"} row center>
                <SIcon name={"Logo"} width={30} />
                <SView width={8} />
                <SText fontSize={14} flex>{"Chequea las condiciones, la fecha de vencimiento y para qué locales sirve."}</SText>
            </SView>
            <SHr />
            <SView col={"xs-12"} row center>
                <SIcon name={"Logo"} width={30} />
