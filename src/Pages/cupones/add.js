    ...
    render_add() {
        return <SView col={"xs-12"} center>
            ...
            <SInput center ref={ref => this.codigo = ref} type='text'
                label={"Ingresa el código con los guiones"} onChangeText={(txt) => {
            ...
            <PButtom
                ...
                onPress={() => {
                    ...
                    if (!code) {
                        this.setState({ loading: false, error: "Inserte el código del cupón." })
                        return;
                    }
                    ...
                    Model.cupon.Action.activar({ code: code }).then((resp) => {
                        ...
                        this.setState({ loading: false, error: "Cupón no encontrado." })
                    })
                }} >SUBIR</PButtom>
            <SHr />
