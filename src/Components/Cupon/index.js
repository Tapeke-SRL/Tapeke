...
export default class Cupon extends Component<propsType> {
    ...
    render() {
        return <SView col={'xs-12'} height={160} style={{
            ...
            <SView col={"xs-4"} backgroundColor={STheme.color.primary} center height>
                <SView width={50} height={50}>
                    <SIcon name='logowhite' fill={STheme.color.white} width={50} />
                </SView>
                <SHr />
            ...
            <SView col={"xs-8"} style={{
                ...
                <SHr height={4} />
                <SText fontSize={12} color={STheme.color.gray}>{"Válido hasta " + new SDate(this.props.data.fecha_off, "yyyy-MM-dd").toString("day. dd de MON. yyyy")}</SText>
