...
import { SDate, SForm, SHr, SIcon, SImage, SLoad, SMath, SNavigation, SPopup, SText, STheme, SView } from 'servisofts-component';
...
export default class QRPedido extends Component<propsType> {
    ...
    render() {
        return <SView col={"xs-12 "} center style={{ backgroundColor: STheme.color.white }}>
            <SView col={"xs-11"} center flex border={"transparent"} >
                <SHr height={40} />
